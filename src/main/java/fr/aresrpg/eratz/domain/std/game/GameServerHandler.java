package fr.aresrpg.eratz.domain.std.game;
...
public interface GameServerHandler {
	...
	void onFightJoin(GameType gameType, FightType fightType, boolean isSpectator, int startTimer, boolean cancelButton, boolean isDuel);
